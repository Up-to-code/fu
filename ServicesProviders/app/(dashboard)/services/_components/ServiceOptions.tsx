...
export function ServiceOptions({ options, onOptionsChange }: ServiceOptionsProps) {
    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
            <h2 className="text-lg font-bold text-[#242C5A]">خيارات الخدمة</h2>
            ...
            <div className="flex items-center gap-2">
                <Input
                    placeholder="خيار جديد (مثال: نوع التسليم)"
