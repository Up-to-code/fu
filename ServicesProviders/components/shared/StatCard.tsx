...
interface StatCardProps {
    ...
    trend?: {
        ...
        label?: string;
        positive?: boolean;
        isPositive?: boolean; // Support both naming conventions
    };
    className?: string;
    ...
    return (
        <Card className={cn("premium-card p-6 h-full border-gray-100 bg-white rounded-2xl", className)}>
            <div className="flex items-center justify-between mb-6">
                <div className={cn("h-12 w-12 rounded-xl bg-gray-50 flex items-center justify-center text-primary transition-all duration-300", iconContainerClassName)}>
