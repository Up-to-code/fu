...
export function DashboardHeader({ verificationStatus }: { verificationStatus: "unverified" | "pending" | "verified" | "rejected" }) {
    return (
        <div className="h-16 border-b border-gray-200 bg-white px-8 flex items-center justify-between sticky top-0 z-50 transition-all">
            <div className="flex items-center gap-6 flex-1">
                <MobileSidebar verificationStatus={verificationStatus} />
